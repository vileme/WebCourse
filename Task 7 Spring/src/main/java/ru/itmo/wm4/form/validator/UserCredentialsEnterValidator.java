...
public class UserCredentialsEnterValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        if (!errors.hasErrors()) {
            ...
            if(userService.findByLoginAndPassword(registerForm.getLogin(),registerForm.getPassword()).isDisabled()){
                errors.rejectValue("password","You.are.disabled","You are disabled");
            }
        }
    }
}
