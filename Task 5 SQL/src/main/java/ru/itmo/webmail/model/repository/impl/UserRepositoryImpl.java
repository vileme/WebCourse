...
public class UserRepositoryImpl implements UserRepository {
    ...
    public User findByLogin(String login) {
        return getUserFromRequest("SELECT * FROM User WHERE login=?", login);
    }
    ...
    public User findByLoginAndPasswordSha(String login, String passwordSha) {
        return getUserFromRequest("SELECT * FROM User WHERE login=? AND passwordSha=?",
                login, passwordSha);
    }
    public User findByEmailAndPasswordSha(String email, String passwordSha){
        return getUserFromRequest("SELECT * FROM User WHERE email=? AND passwordSha=?",email,passwordSha);
    }
