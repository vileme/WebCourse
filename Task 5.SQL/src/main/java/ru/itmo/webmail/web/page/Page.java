...
public class Page {
    ...
    private EmailConfirmationService confirmationService = new EmailConfirmationService();

    public UserService getUserService() {
        return userService;
    }

    public EmailConfirmationService getConfirmationService(){ return confirmationService;
    }
